...
function Hero() {
    ...
    return (
        <div>
                ...
                <div className='flex justify-center w-1/2'>
                    {!submitted ? (
                        <form onSubmit={handleSubmit} className="space-y-4 w-[80%]">
                            ...
                            <div>
                                <label htmlFor="top" className="block text-sm font-medium text-gray-700">Product Rating</label>
                                <input
                                    type="number"
                                    id="top"
                                    name="top"
                            ...
                            <div>
                                <label htmlFor="minPrice" className="block text-sm font-medium text-gray-700">Discount Price</label>
                                <input
                                    type="range"
                                    id="minPrice"
                                    name="minPrice"
                            ...
                            <div>
                                <label htmlFor="maxPrice" className="block text-sm font-medium text-gray-700">Price</label>
                                <input
                                    type="range"
                                    id="maxPrice"
                                    name="maxPrice"
            ...
            <div className="text-[30px] font-bold  ml-12">
                Products
            </div>
